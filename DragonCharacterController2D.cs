...
public class DragonCharacterController2D : MonoBehaviour
{
	...
	private struct DragonRaycastOrigins
	{
	...
	public class DragonCollisionState2D
	{
		public bool right;
		public bool left;
		public bool above;
		...
		{
			return string.Format( "[DragonCollisionState2D] r: {0}, l: {1}, a: {2}, b: {3}, movingDownSlope: {4}, angle: {5}, wasGroundedLastFrame: {6}, becameGroundedThisFrame: {7}",
	...
	public LayerMask platformTeamMask = 0;
	...
	[HideInInspector][NonSerialized]
	public DragonCollisionState2D collisionState = new DragonCollisionState2D();
	[HideInInspector][NonSerialized]
	...
	/// </summary>
	private DragonRaycastOrigins _raycastOrigins;
	
	/// <summary>
	/// stores our raycast hit during movement
	/// </summary>
	private RaycastHit2D _raycastHit;
	private RaycastHit2D _raycastHitTeam;
	...
	/// <summary>
	/// attempts to move the Dragon to position + deltaMovement. Any colliders in the way will cause the movement to
	/// stop when run into.
	/// </summary>
	...
	public void move( Vector3 deltaMovement )
	{
		...
		//				Debug.Log ("X: " + deltaMovement.x + "Y: " + deltaMovement.y);
	...
	private void moveHorizontally( ref Vector3 deltaMovement )
	{
		...
		for( var i = 0; i < totalHorizontalRays; i++ )
		{
			...
			if( i == 0 && collisionState.wasGroundedLastFrame )
			{
				...
				_raycastHitTeam = Physics2D.Raycast( ray, rayDirection, rayDistance, platformTeamMask );

			}
				else{
				_raycastHit = Physics2D.Raycast( ray, rayDirection, rayDistance, platformMask & ~oneWayPlatformMask );
				_raycastHitTeam = Physics2D.Raycast( ray, rayDirection, rayDistance, platformTeamMask & ~oneWayPlatformMask );
